...
public class RandomDessert extends AppCompatActivity {
    int randomIndex;
    Bitmap randomImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_dessert);
        ...
        random_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                nameList = foodDB.fetchDessertName();
                calList = foodDB.fetchDessertCal();
                imageList = foodDB.getDessertImage();
                displayRandomFood();
            }
        });
