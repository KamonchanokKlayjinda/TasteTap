...
public class RandomChinese extends AppCompatActivity {
    int randomIndex;
    Bitmap randomImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_chinese);
        ...
        random_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                nameList = foodDB.fetchChineseName();
                calList = foodDB.fetchChineseCal();
                imageList = foodDB.getChineseImage();
                displayRandomFood();
            }
        });
