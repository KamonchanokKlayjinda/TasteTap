...
public class RandomKorean extends AppCompatActivity {
    int randomIndex;
    Bitmap randomImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_korean);
        ...
        random_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                nameList = foodDB.fetchKoreanName();
                calList = foodDB.fetchKoreanCal();
                imageList = foodDB.getKoreanImage();
                displayRandomFood();
            }
        });
