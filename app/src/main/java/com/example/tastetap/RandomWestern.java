...
public class RandomWestern extends AppCompatActivity {
    int randomIndex;
    Bitmap randomImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_western);
        ...
        random_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                nameList = foodDB.fetchWesternName();
                calList = foodDB.fetchWesternCal();
                imageList = foodDB.getWesternImage();
                displayRandomFood();
            }
        });
