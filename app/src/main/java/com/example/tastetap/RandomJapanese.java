...
public class RandomJapanese extends AppCompatActivity {
    int randomIndex;
    Bitmap randomImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_japanese);
        ...
        random_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                nameList = foodDB.fetchJapaneseName();
                calList = foodDB.fetchJapaneseCal();
                imageList = foodDB.getJapaneseImage();
                displayRandomFood();
            }
        });
