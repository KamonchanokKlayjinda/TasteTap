...
public class RandomIndian extends AppCompatActivity {
    int randomIndex;
    Bitmap randomImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_indian);
        ...
        random_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                nameList = foodDB.fetchIndianName();
                calList = foodDB.fetchIndianCal();
                imageList = foodDB.getIndianImage();
                displayRandomFood();
            }
        });
